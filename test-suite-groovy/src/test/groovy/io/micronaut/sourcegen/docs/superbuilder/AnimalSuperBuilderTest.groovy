...
class AnimalSuperBuilderTest {
    ...
    void testCat() {
        ...
        assertEquals("MrPurr", cat.name)
        assertEquals(2, cat.age)
        assertEquals("British", cat.bread)
        assertEquals(100, cat.meowLevel)
    ...
    void testDog() {
        ...
        assertEquals("MrDog", dog.name)
        assertEquals(3, dog.age)
        assertEquals("JackR", dog.bread)
        assertEquals(20, dog.barkLevel)
        assertEquals("Blue", dog.color)
        assertTrue(dog.big)
    }
//end::test[]
}
