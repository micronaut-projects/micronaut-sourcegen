 ...
 */
package io.micronaut.sourcegen.bytecode.groovy
...
@io.micronaut.sourcegen.bytecode.groovy.Stub
...
@jakarta.inject.Singleton
@Executable
interface MyBean extends io.micronaut.sourcegen.bytecode.groovy.MyPrecompiledInterface {
...
''')
        ...
        !beanDefinition.isAbstract()
        beanDefinition != null
        returnType(beanDefinition, "getPerson").type.name == Person.class.name
        returnType(beanDefinition, "getPeopleArray").type.name.contains(Person.class.name)
        returnType(beanDefinition, "getPeopleMap").typeVariables['K'].type.name == Person.class.name
        returnType(beanDefinition, "getPeopleMap").typeVariables['V'].type == URL
        returnType(beanDefinition, "getPeopleSingle").typeVariables['T'].type== List
        returnType(beanDefinition, "getPeopleSingle").typeVariables['T'].typeVariables['E'].type.name == Person.class.name
        returnType(beanDefinition, "getPeople").type == List
        returnType(beanDefinition, "getPeople").asArgument().hasTypeVariables()
        returnType(beanDefinition, "getPeople").asArgument().typeVariables['E'].type.name == Person.class.name
        returnType(beanDefinition, "getPeopleArray").type.isArray()
        returnType(beanDefinition, "getPeopleListArray").type == List
        returnType(beanDefinition, "getPeopleListArray").typeVariables['E'].type.isArray()
...
@jakarta.inject.Singleton
@Executable
interface MyBean extends io.micronaut.sourcegen.bytecode.groovy.MyPrecompiledInterface<SubPerson> {

}

class SubPerson extends io.micronaut.sourcegen.bytecode.groovy.Person {}
''')
        then:
        !beanDefinition.isAbstract()
        beanDefinition != null
