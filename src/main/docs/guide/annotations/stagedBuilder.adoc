...
snippet::io.micronaut.sourcegen.docs.stagedbuilder.Employee[tags="clazz", indent=0, project-base="test-suite", source="main"]
...
snippet::io.micronaut.sourcegen.docs.stagedbuilder.EmployeeStagedBuilderTest[tags="test", indent=0, project-base="test-suite"]
