...
// The Java sources live in test-suite-tck, which the snippet macro cannot reach because it only
// looks under test-suite-<language>, so the language tabs are spelled out here.
[source.multi-language-sample,java]
----
include::test-suite-tck/src/main/java/io/micronaut/sourcegen/example/Employee.java[tags=clazz,indent=0]
----

[source.multi-language-sample,kotlin]
----
include::test-suite-kotlin/src/main/kotlin/io/micronaut/sourcegen/example/Employee.kt[tags=clazz,indent=0]
----
...
[source.multi-language-sample,java]
----
include::test-suite-tck/src/test/java/io/micronaut/sourcegen/example/EmployeeStagedBuilderTest.java[tags=test,indent=0]
----

[source.multi-language-sample,kotlin]
----
include::test-suite-kotlin/src/test/kotlin/io/micronaut/sourcegen/example/EmployeeStagedBuilderTest.kt[tags=test,indent=0]
----
