...
[source,java]
----
include::test-suite-tck/src/test/java/io/micronaut/sourcegen/example/WalrusTest.java[tags=test,indent=0]
----
...
[source,java]
----
include::test-suite-tck/src/test/java/io/micronaut/sourcegen/example/Walrus2Test.java[tags=test,indent=0]
----
