...
[source,java]
----
include::test-suite-tck/src/main/java/io/micronaut/sourcegen/example/Animal.java[tags=clazz,indent=0]
----

[source,java]
----
include::test-suite-tck/src/main/java/io/micronaut/sourcegen/example/Cat.java[tags=clazz,indent=0]
----

[source,java]
----
include::test-suite-tck/src/main/java/io/micronaut/sourcegen/example/Dog.java[tags=clazz,indent=0]
----
...
[source,java]
----
include::test-suite-tck/src/test/java/io/micronaut/sourcegen/example/AnimalSuperBuilderTest.java[tags=test,indent=0]
----
