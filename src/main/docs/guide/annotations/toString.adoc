...
[source,java]
----
include::test-suite-tck/src/main/java/io/micronaut/sourcegen/example/Elephant.java[tags=clazs,indent=0]
----

.A test case with different examples how new methods can be used
[source,java]
----
include::test-suite-tck/src/test/java/io/micronaut/sourcegen/example/ObjectTest.java[tags=test,indent=0]
----
