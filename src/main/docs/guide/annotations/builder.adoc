...
[source,java]
----
include::test-suite-tck/src/main/java/io/micronaut/sourcegen/example/Person.java[tags=clazz,indent=0]
----
...
[source,java]
----
include::test-suite-tck/src/test/java/io/micronaut/sourcegen/example/PersonBuilderTest.java[tags=test,indent=0]
----
