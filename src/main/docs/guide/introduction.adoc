...
* Kotlin via KAPT
* Kotlin via KSP
* Python via the Python compiler (`micronaut-inject-python`, Micronaut core 5.2+): the generated sources are Java classes compiled together with the Python classes, which Python code uses through host interop
