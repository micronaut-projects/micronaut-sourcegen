...
public final class ClassNameTest {
  ...
  @Test public void bestGuessForString_nestedClass() {
    ...
    assertThat(ClassName.bestGuess(OuterClass.InnerClass.class.getCanonicalName()))
        .isEqualTo(ClassName.get("io.micronaut.sourcegen.javapoet",
  ...
  @Test public void classNameFromTypeElement() {
    ...
    assertThat(ClassName.get(outer).toString()).isEqualTo("io.micronaut.sourcegen.javapoet.ClassNameTest.$Outer");
    TypeElement inner = elements.getTypeElement($Outer.$Inner.class.getCanonicalName());
    assertThat(ClassName.get(inner).toString()).isEqualTo("io.micronaut.sourcegen.javapoet.ClassNameTest.$Outer.$Inner");
  }
  ...
  @Test public void classNameFromTypeElementDoesntUseGetKind() {
    ...
    assertThat(ClassName.get(preventGetKind(outer)).toString())
        .isEqualTo("io.micronaut.sourcegen.javapoet.ClassNameTest.$Outer");
    TypeElement inner = elements.getTypeElement($Outer.$Inner.class.getCanonicalName());
    assertThat(ClassName.get(preventGetKind(inner)).toString())
        .isEqualTo("io.micronaut.sourcegen.javapoet.ClassNameTest.$Outer.$Inner");
  }
  ...
  @Test public void classNameFromClass() {
    ...
    assertThat(ClassName.get(OuterClass.InnerClass.class).toString())
        .isEqualTo("io.micronaut.sourcegen.javapoet.ClassNameTest.OuterClass.InnerClass");
    assertThat((ClassName.get(new Object() {}.getClass())).toString())
        .isEqualTo("io.micronaut.sourcegen.javapoet.ClassNameTest$1");
    assertThat((ClassName.get(new Object() { final Object inner = new Object() {}; }.inner.getClass())).toString())
        .isEqualTo("io.micronaut.sourcegen.javapoet.ClassNameTest$2$1");
