...
class OverrideResolverSpec extends Specification {
    ...
    void "resolves the substituted signature of an erased override"() {
        ...
        when:
        def overridden = OverrideResolver.resolve(classDef, erased, GenerationScope.none())
    ...
    void "resolves nothing for a method that does not override"() {
        ...
        expect:
        OverrideResolver.resolve(classDef, erased, GenerationScope.none()) == null
    }
    ...
    void "resolves nothing for an override that is already typed"() {
        ...
        expect:
        OverrideResolver.resolve(classDef, typed, GenerationScope.none()) == null
    }
    ...
    void "resolves nothing when only the type arguments differ"() {
        ...
        expect:
        OverrideResolver.resolve(classDef, raw, GenerationScope.none()) == null
    }
    ...
    void "resolves an erased parameter of a type variable only for an exact override"() {
        ...
        expect:
        OverrideResolver.resolve(classDef, erased, GenerationScope.none()) == null
        OverrideResolver.resolve(classDef, erased, GenerationScope.none(), true).parameterTypes() == [variable]
    }
    ...
    void "resolves a raw return type only for an exact override"() {
        ...
        expect:
        OverrideResolver.resolve(classDef, raw, GenerationScope.none()) == null
        OverrideResolver.resolve(classDef, raw, GenerationScope.none(), true).returnType() == TypeDef.parameterized(Set, String)
    }
    ...
    void "applies the signature keeping what the method declares"() {
        ...
        when:
        def applied = OverrideResolver.resolve(classDef, erased, GenerationScope.none()).apply(erased)
    ...
    void "resolves nothing through a raw supertype whose variable the declaring type names too"() {
        ...
        expect:
        OverrideResolver.resolve(classDef, erased, GenerationScope.none()) == null
        OverrideResolver.resolve(classDef, erased, GenerationScope.none(), true) == null
    }
    ...
    void "resolves the return type every inherited method accepts"() {
        ...
        expect:
        OverrideResolver.resolve(classDef, erased, GenerationScope.none()).returnType() == TypeDef.of(Integer)
    }
    ...
    void "resolves a covariant generic or array return across inherited methods"() {
        ...
        expect:
        OverrideResolver.resolve(classDef, erased, GenerationScope.none()).returnType() == narrow
    ...
    void "resolves a generated subtype of a parameterized return type"() {
        ...
        expect:
        OverrideResolver.resolve(classDef, classDef.methods[0], GenerationScope.none()).returnType() == narrow
    }
    ...
    void "resolves a type variable within the bound it is declared with"() {
        ...
        expect:
        OverrideResolver.resolve(classDef, classDef.methods[0], GenerationScope.none()).returnType() == variable
    }
    ...
    void "resolves a type variable within every bound its declaration has"() {
        ...
        expect:
        OverrideResolver.resolve(classDef, classDef.methods[0], GenerationScope.none()).returnType() == reference
    }
    ...
    void "resolves two references to one type variable as the same type"() {
        ...
        expect:
        (OverrideResolver.resolve(classDef, classDef.methods[0], GenerationScope.none()).returnType() as TypeDef.TypeVariable).name() == "V"
    }
    ...
    void "resolves the erased signature of a generic method using its own variables next to the class's"() {
        ...
        when:
        def java = OverrideResolver.resolve(classDef, erased, GenerationScope.none())
    ...
    void "resolves a narrower return of a generated type next to a bounded erasure"() {
        ...
        expect:
        OverrideResolver.resolve(classDef, erased, GenerationScope.none()).returnType() == child.asTypeDef()
    }
}
