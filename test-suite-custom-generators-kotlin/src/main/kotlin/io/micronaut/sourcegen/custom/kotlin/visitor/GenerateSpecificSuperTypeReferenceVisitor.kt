...
class GenerateSpecificSuperTypeReferenceVisitor : TypeElementVisitor<GenerateSpecificSuperTypeReference, Any> {
    ...
    override fun visitClass(element: ClassElement, context: VisitorContext) {
        val specificParentType = ClassTypeDef.of(element)
        VariableDef.Super(specificParentType)
        val superMethod = MethodDef.builder("specificSuperCall")
            .addModifiers(Modifier.PUBLIC)
            .returns(ClassTypeDef.of(String::class.java))
            .build { aThis, methodParameters ->
                aThis.superRef(specificParentType)
                    .invoke("specificMethod", ClassTypeDef.of(String::class.java))
                    .returning()
            }
        val classBuilder = ClassDef.builder("SpecificSuperTypeReferenceClass")
            .addModifiers(Modifier.PUBLIC)
